  ...
  return (
    ...
    <main className="p-6 max-w-3xl mx-auto text-sunset container">
          ...
          <div className="grid justify-items-center items-center">
            <p className=" text-sm text-center md:text-lg font-thasadith my-8">Who I am is wrapped up in what I chase: the rabbit holes I fall down, the side projects I lose sleep over, the stories I can’t stop telling. This page is a thread through the creative detours and obsessions that shaped how I think and how I create.</p>
          </div>
            ...
            <div className="grid md:grid-cols-2 md:gap-2 lg:gap-4 gap-y-8 items-center justify-items-center p-4 md:p-8">
              ...
              <div className="order-2 bg-cobalt/50 p-5 mx-auto justify-center rounded-xl relative group">
                <h2>THE BUILDER</h2>
              ...
              <div className="order-4 md:order-3 p-5 mx-auto justify-center border border-smoke rounded-lg relative group">
                <h2>THE JOURNEY</h2>
              ...
              <div className="order-6 bg-cobalt/50 p-5 mx-auto justify-center rounded-xl ">
                <h2>THE FUTURE</h2>
