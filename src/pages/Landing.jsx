...
export default function Landing() {
  ...
  return (
    <>
      <title>Welcome</title>
      <main
        className={`relative flex flex-col items-center justify-center min-h-screen bg-night overflow-hidden transition-opacity duration-300
      ...
      >
        ...
        <div className="relative w-[30vw] aspect-[4/3] flex items-center justify-center">
          ...
          <img
            src={MainKnob}
            className={`h-[7.25%] w-[5.5%] absolute top-[48.5%] right-[27.1%] z-10 ${knobs ? 'animate-spin-knob1' : ''}`}
          ></img>
          <img
            src={MainKnob}
            className={`h-[7.25%] w-[5.5%] absolute top-[55.85%] right-[27.1%] z-10 rotate-135 ${knobs ? 'animate-spin-knob2' : ''}`}
          ></img>
          <img
            src={Button}
            className={`h-[1.75%] w-[1.75%] absolute top-[49.85%] left-[65.45%] z-10 ${buttons1 ? 'animate-b1' : ''}`}
          ></img>
          <img
            src={Button}
            className={`h-[1.75%] w-[1.75%] absolute top-[52.5%] left-[65.45%] z-10 ${buttons2 ? 'animate-b2' : ''}`}
          ></img>
          <img
            src={Button}
            className={`h-[1.75%] w-[1.75%] absolute top-[55.25%] left-[65.45%] z-10 ${knobs ? 'animate-b3' : ''}`}
          ></img>
          <img
            src={Button}
            className={`h-[1.75%] w-[1.75%] absolute top-[58.25%] left-[65.45%] z-10 ${buttons1 ? 'animate-b4' : ''}`}
          ></img>
          <img
            src={Button}
            className={`h-[1.75%] w-[1.75%] absolute top-[60.85%] left-[65.45%] z-10 ${buttons2 ? 'animate-b5' : ''}`}
          ></img>
          <img
            src={BunnyEars}
            alt="bunny ears"
