    ...
    <>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen bg-night">
        ...
        <div className="relative w-[30vw] aspect-[4/3] flex items-center justify-center animate-fade-in-delay-4">
         ...
         />
          <img src="/src/images/MainKnob.png" className="h-[7.25%] w-[5.5%] absolute top-[48.5%] right-[27.1%] z-10"></img>
          <img src="/src/images/MainKnob.png" className="h-[7.25%] w-[5.5%] absolute top-[55.85%] right-[27.1%] z-10 rotate-135"></img>
          <img src="/src/images/button.png" className="h-[1.75%] w-[1.75%] absolute top-[49.85%] left-[65.45%] z-10"></img>
          <img src="/src/images/button.png" className="h-[1.75%] w-[1.75%] absolute top-[52.5%] left-[65.45%] z-10"></img>
          <img src="/src/images/button.png" className="h-[1.75%] w-[1.75%] absolute top-[55.25%] left-[65.45%] z-10"></img>
          <img src="/src/images/button.png" className="h-[1.75%] w-[1.75%] absolute top-[58.25%] left-[65.45%] z-10"></img>
          <img src="/src/images/button.png" className="h-[1.75%] w-[1.75%] absolute top-[60.85%] left-[65.45%] z-10"></img>
          <img
            src="/src/images/bunnyears.png"
            alt="bunny ears"
