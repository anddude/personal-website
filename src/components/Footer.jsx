...
function Footer() {
  ...
  return (
      ...
      <footer className=" text-cobalt text-center z-10">
        ...
        <p className="py-2 font-space text-mustard text-shadow-sm text-shadow-burntOrange ">Let's Connect!</p>
...
>
  ...
  <svg
    ...
    className={`absolute top-0 left-0 w-full h-full transition-all duration-700 ease-in-out 
      ${hoverCalendly ? "opacity-0 rotate-[360deg] scale-75" : "opacity-100 rotate-0 scale-100"}`}
  >
    <path d="M11 14h1v4" />
    <path d="M16 2v4" />
    <path d="M3 10h18" />
  ...
  <svg
    ...
    strokeLinejoin="round"
    className={`absolute top-0 left-0 w-full h-full transition-all duration-700 ease-in-out 
      ${hoverCalendly ? "opacity-100 rotate-0 scale-100" : "opacity-0 -rotate-[360deg] scale-75"}`}
  >
    <path d="M10 2v2" />
    <path d="M14 2v2" />
